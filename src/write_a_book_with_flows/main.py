...
class BookState(BaseModel):
    title: str = "The Current State of Agentic AI in September 2025"
    book: List[Chapter] = []
    book_outline: List[ChapterOutline] = []
    topic: str = (
        "Exploring the latest trends in Agentic AI across different industries as of September 2025"
    )
    goal: str = """
        The goal of this book is to provide a comprehensive overview of the current state of Agentic AI in September 2025.
